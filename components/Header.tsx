    ...
    <header className="site-header">
      <div className="nav-inner">
        ...
        <nav className="desktop-nav">
          <div className="nav-item" onMouseEnter={() => setOpen('therapies')} onMouseLeave={() => setOpen(null)}>
            <Link href="/types-of-therapy">疗法类型</Link>
            {open === 'therapies' && renderDropdown(navMenus.therapies)}
          </div>

          <div className="nav-item" onMouseEnter={() => setOpen('topics')} onMouseLeave={() => setOpen(null)}>
            <Link href="/topics">话题</Link>
            {open === 'topics' && renderDropdown(navMenus.topics)}
          </div>

          <div className="nav-item" onMouseEnter={() => setOpen('struggles')} onMouseLeave={() => setOpen(null)}>
          ...
          <div className="nav-item"  onMouseLeave={() => setOpen(null)}>
      ...
      {mobileOpen && (
        <div className="mobile-drawer">
          ...
          <Link href="/enterprise">企业服务</Link>
          <Link href="/login">登录</Link>
          <Link href="/get-started" className="cta-button mobile">立即开始</Link>
        </div>
      )}
    </header>
  );
